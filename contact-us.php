<?php 
$to = 'johrin@Fictions.me'; // Put in your email address here
$subject  = "Contact Us Form"; // The default subject. Will appear by default in all messages. Change this if you want.

// User info (DO NOT EDIT!)
$name = stripslashes($_REQUEST['contact-name']); // sender's name
$email = stripslashes($_REQUEST['contact-email']); // sender's email
$subject = stripslashes($_REQUEST['contact-sub']); 
$message = stripslashes($_REQUEST['contact-dtl']);
